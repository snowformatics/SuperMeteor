    ...
    for image in image_lst:
        ...
        if meteor_class in output.get('class_ids'):
            ...
            for coord in output.get('rois'):
                ...
                cv2.imwrite(path_out + 'rois7/' + image + '_' + str(n) + '_roi.jpg', roi)
                cv2.imwrite(path_out + 'pos7/' + image + '_' + str(n) + '_org.jpg', org_image)
                cv2.imwrite(path_out + 'pos7/' + image + '_' + str(n) + '_mask.jpg', segmask)
                n += 1
                #if last_polygon:
                    #print (last_polygon)
            ...
            cv2.imwrite(path_out + 'neg7/' + image + '_output.jpg', segmask)
